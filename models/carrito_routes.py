...
def carrito_routes(app):
    try:
        ...
        logger_.Logger.add_to_log("error", str(error), "ordenar_cliente", fecha)
        logger_.Logger.add_to_log("error", traceback.format_exc(), "ordenar_cliente", fecha)
    ...
    def carrito_agregar():
        try:
            ...
            fecha = datetime.now().strftime("%Y%m%d-%H%M%S")
            logger_.Logger.add_to_log("error", str(error), "ordenar", fecha)
            logger_.Logger.add_to_log("error", traceback.format_exc(), "ordenar", fecha)
            return "esto es un error", 501
    ...
    def carrito_actualizar():
        try:
            ...
            fecha = datetime.now().strftime("%Y%m%d-%H%M%S")
            logger_.Logger.add_to_log("error", str(error), "sumar-restar_dentro_del_carrito", fecha)
            logger_.Logger.add_to_log("error", traceback.format_exc(), "sumar-restar_dentro_del_carrito", fecha)
            return "esto es un error", 501
    ...
    def carrito_resumen():
        try:
            ...
            fecha = datetime.now().strftime("%Y%m%d-%H%M%S")
            logger_.Logger.add_to_log("error", str(error), "carrito_resumen", fecha)
            logger_.Logger.add_to_log("error", traceback.format_exc(), "carrito_resumen", fecha)
            return "esto es un error", 501
    ...
    def carrito_checkout():
            try:
                ...
                fecha = datetime.now().strftime("%Y%m%d-%H%M%S")
                logger_.Logger.add_to_log("error", str(error), "comprar", fecha)
                logger_.Logger.add_to_log("error", traceback.format_exc(), "comprar", fecha)
                return "esto es un error", 501
